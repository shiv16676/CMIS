...
public class CMISClient_CreateHRPolicyDoc {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		Folder policyLoggerTestFolder = null;
		for (CmisObject child : children) {
			if(child.getName().equals("PolicyLoggerTest")){
				policyLoggerTestFolder = (Folder) child;
			}
		...
		properties.put(PropertyIds.OBJECT_TYPE_ID, "D:sc:hrPolicy");
		...
		Document marketingDocument = policyLoggerTestFolder.createDocument(properties,
